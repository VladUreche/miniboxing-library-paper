...
\vlad{Feel free to make changes directly on the paper.} If you want to start a discussion, you can use |\romain{text}| , |\milos{text}| or |\nicolas{text}|. The comment above was made using |\vlad{...}|. And you can change your color in the |tweaks.tex| file. Another two things:
