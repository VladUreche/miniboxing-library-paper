...
Project Valhalla is an effort to remedy this problem by specializing classes at load-time so they can efficiently handle primitive values. Recently\footnote{In July 2015 \cite{valhalla-model2-announcement,valhalla-model2-implementation}.}, the Valhalla compilation scheme was extended to enable wildcard quantification over specialized generics, a feature that enables better interaction between specialized and erased generics.
