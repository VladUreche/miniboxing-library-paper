...
The reference-based |mbox| and |spec| methods can directly call each other, since there is a 1 to 1 correspondence. The problem is that, unlike these two methods, none of the unboxed variants have a 1 to 1 correspondence, leaving the interoperation between miniboxing and specialization to occur through boxed values.
