...
%Yet, unlike a C union, which cannot distinguish the original type of the value, miniboxing uses static reified type information to record the type of primitive that is stored.
